...
categories, minNutrition, maxNutrition = gp.multidict({
    ...
    'fat':      [0, 65],
    'sodium':   [0, 1779]})
print(categories, minNutrition, maxNutrition)
...
#
# for c in categories:
#  model.addRange(sum(nutritionValues[f, c] * buy[f] for f in foods),
...
model.addConstr(buy.sum(['milk', 'ice cream']) <= 6, "limit_dairy")
